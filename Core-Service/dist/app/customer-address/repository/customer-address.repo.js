...
export const findAddressesByUserId = async (userId) => {
    return db("customer_addresses")
        ...
        .select("id", "label", "country", "city", "street", "building", "apartment_number as apartmentNumber", "type", "lat", "lng", "is_default as isDefault");
};
...
export const findAddressById = async (addressId, userId) => {
    return db("customer_addresses")
        .where({
        id: addressId,
        user_id: userId,
...
//# sourceMappingURL=customer-address.repo.js.map