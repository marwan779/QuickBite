...
export const BranchProductDetailsNotFoundError = new AppError("Product branch details not found", 404);
export const InvalidBranchIdError = new AppError("Invalid branch ID", 400);
...
export function outOfStockError(offending) {
