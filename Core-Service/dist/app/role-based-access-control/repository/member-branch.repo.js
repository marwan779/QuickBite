...
export async function setMemberBranches(memberId, rows, trx) {
    // delete
    const query = trx || db;
...
export async function findBranchIdsByMemberId(memberId) {
...
export async function countBranchesByIdsAndRestaurant(branchIds, restaurantId) {
    if (!branchIds.length)
        return 0;
...
//# sourceMappingURL=member-branch.repo.js.map